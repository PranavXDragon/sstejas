...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, h as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, i as RequestStatusResponseStatus, U as UnknownError, k as RequestStatusDoneNoReplyErrorCode, m as RejectError, n as CertifiedRejectErrorCode, o as UNREACHABLE_ERROR, I as InputError, p as InvalidReadStateRequestErrorCode, q as ReadRequestType, s as Principal, t as IDL, w as MissingCanisterIdErrorCode, H as HttpAgent, x as encode, Q as QueryResponseStatus, y as UncertifiedRejectErrorCode, z as isV3ResponseBody, A as isV2ResponseBody, B as UncertifiedRejectUpdateErrorCode, D as UnexpectedErrorCode, F as decode, G as Subscribable, J as pendingThenable, K as resolveQueryBoolean, N as shallowEqualObjects, O as resolveStaleTime, V as noop, W as environmentManager, X as isValidTimeout, Y as timeUntilStale, Z as timeoutManager, _ as focusManager, $ as fetchState, a0 as replaceData, a1 as notifyManager, a2 as hashKey, a3 as getDefaultState, r as reactExports, a4 as shouldThrowError, a5 as useQueryClient, a as useInternetIdentity, a6 as createActorWithConfig, a7 as Record, a8 as Opt, a9 as Variant, aa as Vec, ab as Service, ac as Func, ad as Text, ae as Nat, af as Nat8, ag as Null, ah as Bool, ai as Int, aj as Principal$1, ak as Float64 } from "./index-BvuKUqlt.js";
...
Service({
  ...
  "createOrder": Func(
    [Vec(OrderItem), ShippingAddress, Nat],
  ...
  "getOrdersByUser": Func([], [Vec(Order)], ["query"]),
  ...
  "getWishlist": Func([], [Vec(Text)], ["query"]),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "createOrder": IDL2.Func(
      [IDL2.Vec(OrderItem2), ShippingAddress2, IDL2.Nat],
    ...
    "getOrdersByUser": IDL2.Func([], [IDL2.Vec(Order2)], ["query"]),
    ...
    "getWishlist": IDL2.Func([], [IDL2.Vec(IDL2.Text)], ["query"]),
    ...
    "seedProducts": IDL2.Func([], [IDL2.Bool], []),
...
class Backend {
  ...
  async submitContactMessage(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
...
function from_candid_ProductCategory_n22(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_Product_n20(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n11(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: from_candid_Order_n12(_uploadFile, _downloadFile, value.ok)
  } : "err" in value ? {
    __kind__: "err",
    err: value.err
  } : value;
...
function from_candid_variant_n15(_uploadFile, _downloadFile, value) {
  return "Delivered" in value ? "Delivered" : "Processing" in value ? "Processing" : "Shipped" in value ? "Shipped" : "Pending" in value ? "Pending" : value;
}
...
function to_candid_OrderStatus_n26(_uploadFile, _downloadFile, value) {
...
function useOrderById(orderId) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.getOrdersByUser().then(
        (orders) => orders.find((o) => o.id === orderId) ?? null
      );
    },
...
function useCreateOrder() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      return actor.createOrder(items, shippingAddress, totalAmount);
    },
    onSuccess: () => {
...
function useSubmitContactMessage() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("Not connected");
      return actor.submitContactMessage(name, email, category, message);
    }
  });
}
export {
  useAddToWishlist as a,
  useRemoveFromWishlist as b,
  useCreateOrder as c,
  useOrderById as d,
  useUserOrders as e,
  useProducts as f,
  useSubmitContactMessage as g,
  useAllOrders as h,
  useUpdateOrderStatus as i,
  useWishlist as u
};

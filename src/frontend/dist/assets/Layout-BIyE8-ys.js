import { r as reactExports, al as React, am as clsx, j as jsxRuntimeExports, c as cn, e as reactDomExports, R as React$1, a as useInternetIdentity, L as Link, b as useNavigate } from "./index-BvuKUqlt.js";
  ...
  persist(
    (set, get) => ({
          ...
          if (existing) {
            return {
              items: state.items.map(
                (i) => i.product.id === product.id && i.size === size && i.color === color ? { ...i, quantity: i.quantity + quantity } : i
              )
            };
          }
          return {
      ...
      updateQuantity: (productId, size, color, quantity) => {
        ...
        set((state) => ({
          items: state.items.map(
            (i) => i.product.id === productId && i.size === size && i.color === color ? { ...i, quantity } : i
          )
        }));
      },
      clearCart: () => set({ items: [] }),
...
const useWishlistStore = create()(
  persist(
    (set, get) => ({
      ...
      addItem: (productId) => {
        set((state) => ({
          productIds: state.productIds.includes(productId) ? state.productIds : [...state.productIds, productId]
        }));
      },
...
const FOOTER_LINKS = {
  Shop: [
    { label: "New Arrivals", href: "/category/women" },
...
function SearchOverlay({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 bg-background/95 backdrop-blur-sm flex items-start justify-center pt-24 px-4 animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSearch, className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "sr-only", children: "Search" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-3", children: "Press Enter to search or Escape to close" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    searchOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(SearchOverlay, { onClose: () => setSearchOpen(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        "data-ocid": "main-nav",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 lg:h-18", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: mobileOpen, onOpenChange: setMobileOpen, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetContent, { side: "left", className: "w-80 bg-card p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: "/",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 p-6 space-y-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 border-t border-border", children: isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    variant: "outline",
                    onClick: clear,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "nav",
              {
                ...
                children: NAV_CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Link,
                      {
                        ...
                        className: cn(
                          ...
                          activeCategory === cat.slug ? "text-primary border-b border-primary" : "text-foreground"
                        ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  children: [
                    ...
                    wishlistCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-[10px] bg-primary text-primary-foreground border-0 rounded-full", children: wishlistCount })
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  children: [
                    ...
                    itemCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-[10px] bg-primary text-primary-foreground border-0 rounded-full", children: itemCount > 9 ? "9+" : itemCount })
                  ]
                }
              )
            ] })
          ...
          activeCategory && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              onMouseLeave: () => setActiveCategory(null),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-12", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: (_a = NAV_CATEGORIES.find((c) => c.slug === activeCategory)) == null ? void 0 : _a.label }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-l border-border" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Featured" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: ["New Season Edit", "Bestsellers", "Sale"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: "/category/$slug",
                      params: { slug: activeCategory },
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-end p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium bg-background/90 px-2 py-1 rounded", children: item }) })
                    },
                    item
                  )) })
                ] })
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground leading-relaxed max-w-xs", children: "Curated pieces for the modern wardrobe. Timeless design, uncompromised quality." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest mb-3", children: "Newsletter" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
      ...
      Object.entries(FOOTER_LINKS).map(([heading, links]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest mb-4", children: heading }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/faq", className: "hover:text-foreground transition-colors", children: "FAQ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/contact",
...
function Layout({ children, fullWidth = false }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: cn("flex-1", !fullWidth && ""), children }),

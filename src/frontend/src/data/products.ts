...
// All products are hardcoded here and visible immediately on page load.
// No backend call is required for product display.
...
export const STATIC_PRODUCTS: Product[] = [
  // ── Women ──────────────────────────────────────────────────────────────────
  {
    ...
    originalPrice: 28500,
    description:
      "A fluid, cross-front blouse crafted from pure silk charmeuse. Drapes beautifully, transitions effortlessly from day to evening.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    originalPrice: 42000,
    description:
      "High-waisted, wide-leg trousers with a clean front pleat. Made from a luxurious wool-blend fabric with a subtle drape.",
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    originalPrice: 48000,
    description:
      "A relaxed-fit cardigan knitted from 100% Grade-A cashmere. Timeless silhouette with mother-of-pearl buttons.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    originalPrice: 26500,
    description:
      "A satin-finish midi slip dress with adjustable spaghetti straps. Versatile enough to layer or wear solo.",
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    originalPrice: 89000,
    description:
      "A double-breasted wool coat with a belted waist and notch lapels. The season's essential outer layer.",
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: ["Camel", "Black"],
    images: [
...

  {
    ...
    originalPrice: 19500,
    description:
      "A luxuriously soft turtleneck crafted from Grade-A cashmere. Relaxed fit, ribbed collar, cuffs, and hem for a polished finish.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    originalPrice: 16500,
    description:
      "Breathable wide-leg trousers in a relaxed linen blend. Elasticated waist, side pockets — effortlessly chic for warm days.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    originalPrice: 19500,
    description:
      "A flowing midi skirt in a lightweight woven fabric with an allover floral print. Elasticated waistband for an easy, flattering fit.",
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    originalPrice: 59500,
    description:
      "An iconic biker jacket in supple lambskin leather. Asymmetric zip, snap lapels, and quilted shoulder panels for a timeless edge.",
    sizes: ["XS", "S", "M", "L"],
    colors: ["Black", "Cognac"],
    images: [
  ...
  },
  {
    ...
    originalPrice: 36000,
    description:
      "A sculpted slip dress in liquid satin with fine pleating at the bodice. Thin straps, a delicate V-neck — made for evenings.",
    sizes: ["XS", "S", "M", "L"],
  ...
  // ── Men ────────────────────────────────────────────────────────────────────
  {
    ...
    originalPrice: 14500,
    description:
      "A classic Oxford shirt with a relaxed fit and single-button cuffs. Made from a breathable cotton-linen blend.",
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    originalPrice: 24000,
    description:
      "Tailored slim-fit chinos in a stretch-cotton fabric. Clean front profile with a mid-rise waistband.",
  ...
  },
  {
    ...
    originalPrice: 26500,
    description:
      "A fine-gauge merino wool crewneck with a slim silhouette. Exceptionally soft against the skin — ideal for layering.",
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    originalPrice: 39500,
    description:
      "A clean, minimal Harrington jacket in a water-repellent cotton shell. Classic checked lining, snap-button placket.",
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    originalPrice: 44000,
    description:
      "Slim-tapered suit trousers in an Italian wool blend. Flat-front, mid-rise — versatile for business or occasion.",
    sizes: ["28", "30", "32", "34", "36"],
...

  {
    ...
    originalPrice: 22500,
    description:
      "A premium fine-knit crewneck in 100% extra-fine merino wool. Lightweight, itch-free, and exceptionally warm for its weight.",
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    originalPrice: 17500,
    description:
      "Versatile slim-cut chinos in a brushed stretch-cotton twill. Clean silhouette, five-pocket styling — weekend to boardroom ready.",
  ...
  },
  {
    ...
    originalPrice: 11500,
    description:
      "A summer-ready shirt in a breathable linen-cotton blend. Relaxed fit, button-down collar, single chest pocket.",
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    originalPrice: 44500,
    description:
      "Sleek Chelsea boots in smooth full-grain leather. Elastic side panels, pull tabs, and a stacked leather heel.",
  ...
  },
  {
    ...
    originalPrice: 34500,
    description:
      "A modern bomber in a water-resistant ripstop shell with a quilted satin lining. Rib-knit cuffs, zip pockets, contrast inner collar.",
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  // ── Kids ───────────────────────────────────────────────────────────────────
  {
    ...
    originalPrice: 8500,
    description:
      "A soft, durable hoodie made from 100% GOTS-certified organic cotton. Kangaroo pocket and adjustable drawstring.",
  ...
  },
  {
    ...
    originalPrice: 8500,
    description:
      "Comfortable pull-on joggers with an elastic waistband and tapered leg. Easy to dress, easy to move in.",
  ...
  },
  {
    ...
    originalPrice: 11500,
    description:
      "A lightweight quilted puffer vest with a zip front and mock-neck collar. Packable and water-resistant.",
  ...
  },
  {
    ...
    originalPrice: 9800,
    description:
      "A cheerful striped knit dress with a smocked bodice and short puff sleeves. Comfortable for all-day wear.",
    sizes: ["3Y", "4Y", "6Y", "8Y"],
  ...
  },
  {
    ...
    originalPrice: 9500,
    description:
      "Classic low-top canvas sneakers with a rubber sole and cushioned insole. Durable enough for the playground.",
...

  {
    ...
    originalPrice: 4500,
    description:
      "A soft Breton-stripe tee in 100% cotton jersey. Crew neck, short sleeves — a timeless kids' wardrobe staple.",
  ...
  },
  {
    ...
    originalPrice: 9800,
    description:
      "Classic dungarees in soft washed denim with adjustable shoulder straps, a bib pocket, and side snap buttons for easy dressing.",
  ...
  },
  {
    ...
    originalPrice: 6500,
    description:
      "A sweet floral-print cotton dress with short puff sleeves, a gathered skirt, and a back zip. Perfect for any occasion.",
    sizes: ["3Y", "4Y", "6Y", "8Y", "10Y"],
  ...
  },
  {
    ...
    originalPrice: 7000,
    description:
      "A cosy pullover hoodie in soft French-terry cotton. Kangaroo pocket, adjustable drawstring, and ribbed cuffs.",
    sizes: ["4Y", "6Y", "8Y", "10Y", "12Y"],
  ...
  },
  {
    ...
    originalPrice: 4800,
    description:
      "Easy-on velcro canvas sneakers with a non-slip rubber sole and cushioned footbed. Built for little adventurers.",
  ...
  // ── Accessories ────────────────────────────────────────────────────────────
  {
    ...
    originalPrice: 62000,
    description:
      "A roomy structured tote in full-grain leather. Interior pockets, magnetic snap closure, and detachable key clip.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    originalPrice: 24000,
    description:
      "A generously sized scarf woven from 100% pure cashmere. Lightweight yet warm, with fringed ends.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    originalPrice: 23500,
    description:
      "Classic teardrop aviator frames with polarised lenses in premium polycarbonate. UV400 protection. Gold-tone metal frame.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    originalPrice: 12500,
    description:
      "A slim full-grain leather belt with a brushed brass buckle. Minimal, refined, enduring.",
  ...
  },
  {
    ...
    originalPrice: 8500,
    description:
      "A heritage flat cap in a warm wool-tweed blend. Structured brim, satin lining, and an adjustable inner band.",
    sizes: ["S/M", "L/XL"],
  ...
  },
  {
    ...
    originalPrice: 38500,
    description:
      "A spacious structured tote in pebbled vegan leather with a zip top, inner organiser pockets, and an adjustable crossbody strap.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    originalPrice: 12500,
    description:
      "A 90×90cm square silk scarf with a hand-rolled hem. Wear it around your neck, as a headband, or tied on your bag.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    originalPrice: 12000,
    description:
      "A sleek hand-woven belt in genuine full-grain leather. Polished silver pin buckle — the finishing touch for any outfit.",
    sizes: ["S (28–30)", "M (32–34)", "L (36–38)", "XL (40–42)"],
  ...
  },
  {
    ...
    originalPrice: 8500,
    description:
      "Classic 14k gold-plated hoop earrings in a medium diameter. Lightweight, hypoallergenic posts — everyday elegance.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    originalPrice: 7500,
    description:
      "A slouchy, ribbed beanie in cloud-soft pure cashmere. Generously cut for a relaxed fit — the winter essential you'll reach for daily.",
    sizes: ["One Size"],

...
import type { Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Product as _Product, ProductCategory as _ProductCategory, ShippingAddress as _ShippingAddress, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: Array<OrderItem>, arg1: ShippingAddress, arg2: bigint): Promise<{
        __kind__: "ok";
        ok: Order;
    } | {
        __kind__: "err";
    ...
    async submitContactMessage(arg0: string, arg1: string, arg2: string, arg3: string): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "err";
...
function from_candid_variant_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Men" in value ? ProductCategory.Men : "Accessories" in value ? ProductCategory.Accessories : "Kids" in value ? ProductCategory.Kids : "Women" in value ? ProductCategory.Women : value;
}
